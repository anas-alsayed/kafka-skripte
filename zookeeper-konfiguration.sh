...
do
	if [ $zeile -gt 0 ] 
	then
		#Der Pfad, wo die CSV-Datei liegt
		cd /home/r00t/Desktop/Skripte-Projekt-Final
		#Suche in der CSV-Datei nach allen Hosts, desen Namen mit z. B. "stg" anfängt.
		#Speichere in der Variable "Zookeepers" die Host-Namen und jeweils auch die Ports (Leader und Election)
		#Danach trenne die gesuchten Werte der Variable "Zookeepers" in ein Array
